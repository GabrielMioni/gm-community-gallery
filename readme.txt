...
1. GM Submit Form: This is where your visitors and/or fans can upload images.
...
1. Send Notification - If this is enabled, an email will be sent every time someone submits an image. By default this will be the email addres associated witth the WordPress administrator, but you can set a different email address in the 'Notification Email' field.
...
Here you can search for and navigate the images in your gallery. Percentage signs [ % ] can be used as wildcards (eg, searching 'Bill%' will find both 'Billie' and 'Billy').
